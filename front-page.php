<?php get_header(); //Front page template for home page ?>
    ...
    <div class="full-width-split group">
      <div class="full-width-split__one">
        ...
        <?php
         ...
         while ($homepageEvents->have_posts()) {
                $homepageEvents->the_post(); //Gets appropriate data ready ?>
          ...
          <p class="t-center no-margin"><a href="<?php echo get_post_type_archive_link('event') //Links to apprpriate archive page ?>" class="btn btn--blue">View All Events</a></p>
        </div>
      </div>
      <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            $homepagePosts = new WP_Query(array(
               'posts_per_page' => 2,
                ...
                while ($homepagePosts->have_posts()) {
                    $homepagePosts->the_post(); //Gets appropriate data ready ?>
                    <div class="event-summary">
          ...
          <p class="t-center no-margin"><a href="<?php echo site_url('/blog'); //site_url => absolute url to chosen slug?>" class="btn btn--yellow">View All Blog Posts</a></p>
        </div>
      </div>
    </div>
