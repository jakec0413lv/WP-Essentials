<!DOCTYPE html>
<html <?php language_attributes(); //Language tags ?>>
    <head>
        <meta charset="<?php bloginfo('charset'); //Charset tag?>">
        <meta name="viewport" content="width=device-width, initial-scale=1"> <!--- Mobile friendly design [Requires responsive CSS] -->
        <?php wp_head(); ?>
    </head>
    <body <?php body_class(); //Adds attribute for body class ?>>
        ...
        <div class="container">
           ...
           <?php 
                //wp_nav_menu(array( --Dynamic Menu Addition
